...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-servicebus";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests — admin/topology library, no live Service Bus.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.ServiceBus.V7.Tests" / "Tamp.ServiceBus.V7.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.ServiceBus.V7" / "Tamp.ServiceBus.V7.csproj");
